            ...
            <form class="form-horizontal" action="RegisterUser" method="POST">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="forename" name="forename" type="text" placeholder="" class="form-control input-md" required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="datepicker" name="dateofbirth" type="text" class="form-control input-md">
