    ...
    <body>
        ...
        <div class="container">
            <div class="main-content">
                <div class="header">
                    <div class="logo">
                        <a href="adminlogin.jsp" style="font-family:Montserrat"><h1>Cinephile</h1></a>
                    </div>
                    <div class="search">
                        <div class="search2">
                            <form>
                ...
                <div class="main-banner">
                    <section class="slider">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="images/spectre2.jpg" height="600px" class="img-responsive" alt="" />
                                </li>
                                <li>
                                    <img src="images/swfa.jpg" class="img-responsive" alt="" />
                                </li>
                                <li>
                                    <img src="images/revenant.jpg" class="img-responsive" alt="" />
                                </li>
                                <li>
                                    <img src="images/tgd.jpg" class="img-responsive" alt="" />
                                </li>
                            </ul>
                        </div>
                    </section>
